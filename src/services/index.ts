...
// 					result200!.push(Pet.fromJS(item, _mappings));
// 			}
// 			else {
// 				result200 = <any>null;
// 			}
...
// 			let result200: any = null;
// 			let resultData200  = _responseText;
// 			result200 = Pet.fromJS(resultData200, _mappings);
// 			return Promise.resolve<Pet>(result200);
//
// 		} else if (status === 400) {
// 			const _responseText = response.data;
...
// 					this.tags[i] = item && !(<any>item).toJSON ? new Tag(item) : <Tag>item;
// 				}
// 			}
// 		}
// 		if (!data) {
...
// 					this.tags!.push(Tag.fromJS(item, _mappings));
// 			}
...
// 	}
//
// 	static fromJS(data: any, _mappings?: any): Tag | null {
// 		data = typeof data === 'object' ? data : {};
// 		return createInstance<Tag>(data, _mappings, Tag);
// 	}
//
// 	toJSON(data?: any) {
// 		data = typeof data === 'object' ? data : {};
