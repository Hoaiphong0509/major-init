...
interface PostDetailWithReduxPageProps {}

const PostDetailWithReduxPage: FC<PostDetailWithReduxPageProps> = () => {
	...
	const {
		postDetail,
		loading: loadingPost
	} = useAppSelector(state => state.demo.post)

	const fetchPostDetail = (postId: number) => dispatch(getPostDetailThunk(postId))
...
export default PostDetailWithReduxPage